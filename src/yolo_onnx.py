...
def process_img(img0, imgsz=(640, 640), stride=32, auto=True):
...
class YOLOOnnx:
    def __init__(
        ...
        yolo_session, _stride, _names = get_yolo_onnx(weights)
    ...
    def __call__(self, img0):
        ...
        Args:
            img0 (cv2 Image or np.array):

        Returns:
            pred: [[xyxy, clsId, conf]]
        """
        img = process_img(img0, self.imgsz, self.stride, self.auto)
